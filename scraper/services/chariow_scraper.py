...
class ChariowScraper:
    ...
    async def scrape_shop(self, shop_url: str) -> Dict[str, Any]:
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                # Détecter TOUS les produits via le pattern prd_
    ...
    def _find_product_urls(self, soup: BeautifulSoup, base_url: str) -> List[str]:
        """
        Trouve TOUS les URLs de produits via le pattern prd_
        Pattern: https://<boutique>.mychariow.shop/prd_xxxxxx
        """
        product_urls = set()
        ...
        for elem in soup.find_all(attrs=True):
            for attr, value in elem.attrs.items():
                if isinstance(value, str) and '/prd_' in value:
